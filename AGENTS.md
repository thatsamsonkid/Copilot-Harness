...
Unknown workplace words or acronyms: `.github/skills/glossary/SKILL.md` (`uv run goat glossary get TERM`). Org terms live in `catalog/glossary.yml`. Product-only acronyms may live in a sibling `docs/glossary.yml`. Do not guess team language, and do not turn the glossary into a feature wiki.
