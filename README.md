...
| `.github/hooks/implement-gate.json` | Deny parent product-file edits during `/goat-implement` (Code Writer must write them) |
...
| `.github/prompts/goat-plan.prompt.md` | `/goat-plan` |
| `.github/prompts/goat-implement.prompt.md` | `/goat-implement` |
