...
- Ask for missing params one at a time: id (slug), name, description, which projects to include, whether to keep this goat as the first folder. Optional Jira match fields only if they bring them up.
