...
- After changes, invoke **Verifier** for that repo's verify commands and say which sibling repo each commit belongs to. Do not squash unrelated repos together. Follow **Bounded verify** in the implementing skill — do not let Verifier retry or patch.
