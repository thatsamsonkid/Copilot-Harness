...
2. Otherwise invoke **Bulk Reader** (`#tool:agent`) with the exact survey question and repo-relative paths. Each call is stateless. Its profile pins Copilot Auto (`Auto (copilot)`) — do not override the model.
