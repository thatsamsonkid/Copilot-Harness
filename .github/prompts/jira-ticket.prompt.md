...
7. For a survey of named product files or symbols, invoke **Bulk Reader** (`#tool:agent`). Its profile pins Claude Haiku 4.5 — do not override the model. Do not invoke Bulk Reader for debugging, architectural decisions, or safety-critical analysis — targeted-`Read` those yourself. Do not invoke **Code Writer**. Do not edit product code.
