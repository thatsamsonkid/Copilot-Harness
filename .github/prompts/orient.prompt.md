...
2. Summarize each cloned repo: Graphify report present or not, instruction files, and suggested verify commands.
3. If any `graphify.report` exists, read those Markdown reports before searching product code.
