#!/usr/bin/env bash
# Idempotent Cloud Agent bootstrap for the Copilot Harness.
...
uv run harness workspace generate >/dev/null

echo "Copilot Harness environment ready. Run: uv run harness <command>"
