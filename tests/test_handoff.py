...
from goat.handoff import latest_handoff, write_handoff


def test_handoff_write_and_latest(goat_root: Path, capsys, monkeypatch):
...
def test_write_handoff_omits_secrets(goat_root: Path):
    ...
    latest = latest_handoff(goat_root)
