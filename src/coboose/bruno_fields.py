...
DEFAULT_TAGS = ("bruno",)
DEFAULT_ENV = "local"
DEFAULT_WORKFLOWS_FILE = "coboose.workflows.yml"
DEFAULT_SERVICES_FILE = "coboose.services.yml"
...
INVENTORY_NOTE = (
    "bru run executes HTTP from a collection root. coboose only resolves "
