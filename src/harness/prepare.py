...
def prepare_issue(
    ...
    *,
    ...
    next_steps = [
        ...
        f"Use branch name {suggested_branch(issue['key'])} in each touched sibling (`harness branch {issue['key']}`).",
