    ...
    *,
    ...
    for repo_id in catalog.workspace_repo_names(workspace):
        ...
        item = {
            ...
            "language_skill": snapshot["language_skill"],
    ...
    next_steps = [
        ...
        "Before editing, load that repo's instruction files, the matching language skill (language_skill), and knowledge notes; use tooling.suggested_verify after changes.",
